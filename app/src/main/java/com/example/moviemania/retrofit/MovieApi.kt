...
interface MovieApi {
    ...
    fun getPopularMovies(@Query("api_key") apiKey: String,
                         @Query("vote_average.gte") minRating: Int = 7,
    ...
    fun getMovieGenresList(@Query("api_key") apiKey: String): Call<MoviesDetails>

    @GET("discover/movie")
    fun getMoviesByGenre(@Query("api_key") apiKey: String,
                         @Query("with_genres") genreId: String) :Call<MoviesList>
